...
<%@page import="model.O_DonHang_SanPham"%>
<%@page import="model.D_DonHang_SanPham"%>
...
<body class="">
	...
	<%
        ...
        D_DonHang_SanPham d = new D_DonHang_SanPham();
        O_DonHang_SanPham o = new O_DonHang_SanPham();

        ObjectSet<O_DonHang_SanPham> lstDonHangSanPham = d.selectAll(db);
		int i=0;
		%>
				...
				<div class="grid-body" id="grid-body_bch" value="0" style="display: normal">
					<table id="table_data" cellpadding="0" cellspacing="0" border="0" class="table  dataTable" width="100%">
						...
						<tbody role="alert" aria-live="polite" aria-relevant="all">
							<%
								for (O_DonHang_SanPham item : lstDonHangSanPham) {
							%>
							<tr class="">
								<td>
								...
								<td class=" sorting_1">
									<%
											out.println(item.getDonhang().getDh_ma());
										%>
								</td>
								<td class=" sorting_1">
									<%
										out.println(item.getSanpham().getSp_ten());
									%>
								</td>
								<td class=" sorting_1">
									<%
										out.println(item.getSp_dh_soluong());
									%>
								</td>
								<td>
	...
	<!-- END CHAT -->
	<!-- END CONTAINER -->
	<div id="dialog_themDonHang" title="THÊM ĐƠN HÀNG CHI TIẾT" style="display: none; text-align: center;">
		<form name="frmThem" method="post">
			<table width="100%" border="0" class="" cellpadding="5px">
				...
				<tr>
					<td align="left" class="cell-dialog">Số lượng<font color="red">*</font>
					</td>
					<td align="left" class="cell-dialog">
